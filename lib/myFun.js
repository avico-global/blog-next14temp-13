...
export const getDomain = (host) => {
  const defaultDomain = "24-losangeles-carpet-cleaning.sitebuilderz.com";
  // const defaultDomain = "a1-a-auto-and-truck.sitebuilderz.com";

  // const defaultDomain = "chet-wilson.sitebuilderz.com";
